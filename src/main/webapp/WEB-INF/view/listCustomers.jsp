	...
	<div class="container">
		...
		<form:form action="searchCustomer" method="GET">
			...
			<div class="d-grip gap-2 d-md-flex justify-content-md-end">
				<input class="btn btn-primary submit" type="submit" value="Add Customer"
			...
			<tbody>
				<c:forEach var="customer" items="${customers}">
					<tr>
						...
						<c:url var="delete" value="/showFormForDelete">
							<c:param name="customerId" value="${customer.id}"/>
						</c:url>	
		...
		<a href="${pageContext.request.contextPath}/api/customers">Get all Customers JSON</a>
	</div>
